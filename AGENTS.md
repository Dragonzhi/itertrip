...
> 版本：v1.3 · 2026-09-06 · 适用代码库：`backend/`（FastAPI）+ `frontend/`（React 18 + Vite）
...
*本文档基于代码实测编写（2026-09-06，对应 main 分支；M18 记忆库、M19 坐标核验与决策轨迹、M20 坐标区域校验与「校准坐标」均已实测端到端跑通）。若提示词、参数或协议调整，请同步更新本文件。*
